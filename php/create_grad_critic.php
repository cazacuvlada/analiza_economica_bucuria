...
if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    $produse_A=$_POST["produse_A"];
    $produse_B=$_POST["produse_B"];
    $produse_C=$_POST["produse_C"];
    $total=$_POST["total"];
    ...
    do{
        ...
        $sql = "INSERT INTO `gradul_critic`(indicatori,produse_A_produse_B,produse_C, total)
        VALUES ('$indicatori','$produse_A,' $produse_B',' $produse_C',' $total')";
...
header("location:../menu/gradul_critic.php");
exit;
...
<div class="home-btn">
    <a href="../menu/gradul_critic.php">Gradul Critic </a>
</div>
...
<div class="col-sm-6">
    <input type="text" class="form-control" name="indicatori" value="<?php echo $indicatori; ?>">
            ...
            <div class="row mb-3">
<label class="col-sm-3 col-form-label ">Produse A</label>
<div class="col-sm-6">
    <input type="text" class="form-control" name="produse_A" value="<?php echo $produse_A; ?>">
</div>
            </div>
            <div class="row mb-3">
<label class="col-sm-3 col-form-label ">Produse B</label>
<div class="col-sm-6">
    <input type="text" class="form-control" name="produse_B" value="<?php echo $produse_B; ?>">
</div>
            </div>
            <div class="row mb-3">
<label class="col-sm-3 col-form-label ">Produse C</label>
<div class="col-sm-6">
    <input type="text" class="form-control" name="produse_C" value="<?php echo $produse_C; ?>">
</div>
            </div>
            <div class="row mb-3">
