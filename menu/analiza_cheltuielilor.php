...
<div class="container_2 my-5">
    <h2 style="text-align:center;"  >Analiza cheltuielilor</h2>
    <a  style="color:white;background-color:lightslategray; position:relative; left:6vh;"  class="btn btn-primary" href="../php/create_analiz_cheltuieli.php" role="button">New Row</a>
    <br>
    <table class="new_row">
        <thead>
        <tr>
        ...
        $sql = "SELECT * FROM analiza_cheltuieli";
        ...
        while($row = $result->fetch_assoc()){
            echo " <tr>
           <td>$row[id]</td>
            <td>$row[activitati]</td>
            <td>$row[an_curent]</td>
            <td>$row[programat]</td>
            <td>$row[realizat]</td>
            <td>$row[pondere_cheltuieli]</td>
            <td>
