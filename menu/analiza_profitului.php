...
<div class="container_2 my-5">
    <h2 style="text-align:center;"  >Analiza profit aferent</h2>
    <a  style="color:white;background-color:lightslategray; position:relative; left:6vh;"  class="btn btn-primary" href="../php/create_analiz_profit.php" role="button">New Row</a>
    <br>
    <table class="new_row">
        <thead>
        <tr>
        ...
        $sql = "SELECT * FROM analiza_profit_aferent";
